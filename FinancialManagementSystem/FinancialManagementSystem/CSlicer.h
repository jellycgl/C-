...
#include <afxdisp.h>
// CSlicer wrapper class

class CSlicer : public COleDispatchDriver
{
public:
	CSlicer(){} // Calls COleDispatchDriver default constructor
...
public:
	...
	LPDISPATCH get_TimelineViewState()
	{
		LPDISPATCH result;
		InvokeHelper(0xc2c, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
		return result;
	}
